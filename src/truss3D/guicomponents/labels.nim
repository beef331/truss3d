...
proc new*(_: typedesc[Label], pos, size: IVec2, text: string, color = vec4(1), anchor = {left, top}, horizontalAlignment = CenterAlign, verticalAlignment = MiddleAlign, fontsize = 30f): Label =
